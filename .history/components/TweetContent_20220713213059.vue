  ...
  <div>
    <div v-for="tweet in showTweets" :key="tweet.id" class="tweet__show">
      <div class="tweet__show__inner">
        ...
        <div class="like__btn" @click="onLikeBtn(tweet.id)" @click="onLikeClick(comment)"
          :class="{ 'heart-animation': comment.liked_by_user }"><img src="../img/heart.png" class="like__img"><span
