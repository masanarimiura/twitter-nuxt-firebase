  ...
  <div class="side__bar">
    ...
    <validation-observer ref="obs" v-slot="ObserverProps">
      <validation-provider v-slot="{ errors }" rules="required|max:120">
        <textarea v-model="tweet_content" id="tweet_content" type="text" name="シェア"></textarea>
        <div class="error">{{ errors[0] }}</div>
      </validation-provider>
      <button type="button" :disabled="ObserverProps.invalid || !ObserverProps.validated" class="tweet__btn" @click="insertContact" >送信</button>
    </validation-observer>
