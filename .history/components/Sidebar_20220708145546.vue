<template>
  <div class="side__bar">
    <NuxtLink to="/" class="side__bar__link"><img src="../img/logo.png" class="side__bar__logo"></img></NuxtLink>
    <NuxtLink to="/"><img src="../img/home.png" class="side__bar__home"></img>ホーム</NuxtLink>
    <NuxtLink to="/" class="logout" @click="logout"><img src="../img/logout.png" class="side__bar__home"></img>ログアウト</NuxtLink>
