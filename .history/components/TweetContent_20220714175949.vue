  ...
  <div>
    <div v-for="tweet in showTweets" :key="tweet.id" class="tweet__show">
      <div class="tweet__show__inner">
        ...
        <div class="like__btn" v-show="$store.state.loginUserId == tweet.likes.user_id" @click="clickUnlike(tweet)">
          <img src="../img/heart.png" class="like__img"><span class="likes">{{ tweet.likes.length }}</span>
        </div>
        <!-- <div class="like__btn" v-show="$store.state.loginUserId != tweet.likes.user_id" @click="clickLike(tweet)">
          <img src="../img/heart.png" class="like__img"><span class="likes">{{ tweet.likes.length }}</span>
        </div> -->
