  ...
  <div class="register">
    ...
    <div class="register__inner">
      <div class="register__box">
        <p>新規登録</p>
        <br />
        <input v-model="name" v-modal="dbname" type="name" id="name" required placeholder="ユーザーネーム" />
        <br />
        <input v-model="email" v-modal="dbemail" type="email" required placeholder="メールアドレス" />
        <br />
        <input v-model="password" v-modal="dbpasswo" type="password" required placeholder="パスワード" />
        <br />
